// InfiniteMenu - Vanilla JavaScript WebGL Implementation
// Adapted from React component to work with vanilla JS

import { mat4, quat, vec2, vec3 } from 'https://cdn.skypack.dev/gl-matrix@3.4.3';
            ...
            img.onerror = () => {
              ...
              placeholder.src = 'data:image/svg+xml,' + encodeURIComponent(`
                <svg width="512" height="512" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <text x="50%" y="50%" font-size="24" fill="#fff" text-anchor="middle" dominant-baseline="middle">${item.title}</text>
                </svg>
              `);
            };
            img.src = item.image;
